package com.interesting.config.redis.config;
...
import com.interesting.config.redis.receiver.RedisReceiver;
import com.interesting.config.redis.writer.JeecgRedisCacheWriter;
