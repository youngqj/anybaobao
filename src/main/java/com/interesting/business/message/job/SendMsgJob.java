//package com.interesting.business.message.job;
//
...
//import com.interesting.business.message.handle.enums.SendMsgStatusEnum;
//import com.interesting.business.message.handle.enums.SendMsgTypeEnum;
...
//
//        log.info(String.format(" Jeecg-Boot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getFormatDate()));
//
