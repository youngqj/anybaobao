...
import com.interesting.business.system.model.SysLoginModel;
...
import com.interesting.business.system.util.RandImageUtil;
...
import com.interesting.common.util.encryption.EncryptedString;
...
public class LoginController {
    ...
    public Result<Object> logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (sysUser != null) {
            ...
            redisUtil.del(String.format("%s::%s", CacheConstant.SYS_USERS_CACHE, sysUser.getPhone()));
            //调用shiro的logout
...
//					b = DySmsHelper.sendSms(mobile, obj, DySmsEnum.FORGET_PASSWORD_TEMPLATE_CODE);
    ...
    private Result<JSONObject> userInfo(SysUser sysUser, Result<JSONObject> result) {
        ...
        redisUtil.expire(CommonConstant.PREFIX_USER_TOKEN + token, 2147483647);
        ...
        // add user role_code list
        List<Integer> roleCodes = sysUserService.getRoleCodesByUsername(username);
