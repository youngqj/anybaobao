...
public interface SysPermissionMapper extends BaseMapper<SysPermission> {
     ...
     * 获取模糊匹配规则的数据权限URL
     */
    @Select("SELECT url FROM sys_permission WHERE iz_delete = 0 and menu_type = 2 and url like '%*%'")
     ...
     * @return
     */
    List<SysPermission> queryParentByUser(@Param("username") String username);
