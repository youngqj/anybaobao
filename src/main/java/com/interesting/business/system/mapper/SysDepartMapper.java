...
public interface SysDepartMapper extends BaseMapper<SysDepart> {
	 ...
	 * @return
	 */
	@Select("SELECT count(*) FROM sys_depart where iz_delete ='0' AND parent_id = #{parentId,jdbcType=VARCHAR}")
	 ...
	 * @return
	 */
	@Select("SELECT * FROM sys_depart where iz_delete ='0' AND parent_id = #{parentId,jdbcType=VARCHAR}")
