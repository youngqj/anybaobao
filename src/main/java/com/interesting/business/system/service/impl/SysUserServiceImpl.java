...
import com.interesting.business.system.vo.SysUserVo;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    public Result<?> resetPassword(String username, String oldpassword, String newpassword, String confirmpassword) {
        ...
        // 先解密前端密码
        try {
            oldpassword = AESUtils.aesDecrypt(oldpassword,AESUtils.key);
            newpassword = AESUtils.aesDecrypt(newpassword,AESUtils.key);
            confirmpassword = AESUtils.aesDecrypt(confirmpassword,AESUtils.key);
        } catch (Exception e) {
    ...
    @Override
    public List<Integer> getRoleCodesByUsername(String username) {
        return sysUserRoleMapper.getRoleNumsByUserName(username);
    }
...
//		info.setSysUserName(user.getRealname());
    ...
    public IPage<SysUser> getUserByDepartIdAndQueryWrapper(Page<SysUser> page, String departId, QueryWrapper<SysUser> queryWrapper) {
        ...
        lambdaQueryWrapper.eq(SysUser::getIzDelete, CommonConstant.IZ_DELETE_0);
...
//		this.save(user);  //保存角色的时候已经添加过一次了
    ...
    public Result<?> checkUserIsEffective(SysUser sysUser) {
        ...
        if (CommonConstant.IZ_DELETE_1.equals(sysUser.getIzDelete())) {
    ...
    public List<SysUser> queryLogicDeleted(LambdaQueryWrapper<SysUser> wrapper) {
        ...
        wrapper.eq(SysUser::getIzDelete, CommonConstant.IZ_DELETE_1);
    ...
    @Override
    public Map<String, SysUserVo> getUserDetailByIds(List<String> userId) {
        return userMapper.getUserDetailByIds(userId);
    }
