...
import com.interesting.business.system.mapper.SysDepartPermissionMapper;
import com.interesting.business.system.mapper.SysDepartRolePermissionMapper;
import com.interesting.business.system.mapper.SysPermissionMapper;
import com.interesting.business.system.mapper.SysRolePermissionMapper;
import com.interesting.business.system.model.TreeModel;
import com.interesting.business.system.service.ISysPermissionDataRuleService;
import com.interesting.business.system.service.ISysPermissionService;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
    ...
    public void deletePermission(String id) throws InterestingBootException {
        ...
        if (sysPermission == null) {
            throw new InterestingBootException("未找到菜单信息");
        }
    ...
    @Override
    public List<SysPermission> queryParentByUser(String username) {
        return this.sysPermissionMapper.queryParentByUser(username);
    }

    @Override
    public List<SysPermission> queryByUserIdAndParentId(String username, String parentId) {
        return this.sysPermissionMapper.queryByUserIdAndParentId(username, parentId);
    }
