...
import com.interesting.business.system.mapper.SysDictMapper;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	public Map<String, DictModel> queryDictItemsMapByCode(String code) {
		return sysDictMapper.queryDictItemsMapByCode(code);
	}
    ...
    public boolean deleteByDictId(SysDict sysDict) {
        sysDict.setIzDelete(CommonConstant.IZ_DELETE_1);
