...
import com.interesting.business.system.util.FindsDepartsChildrenUtil;
...
public class SysDepartServiceImpl extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
    ...
    public List<SysDepartTreeModel> queryMyDeptTreeList(String departIds) {
        ...
        query.eq(SysDepart::getIzDelete, CommonConstant.IZ_DELETE_0);
     ...
     */
    @Override
    public List<SysDepartTreeModel> queryTreeList(String enterpriseInfoId) {
        LambdaQueryWrapper<SysDepart> query = new LambdaQueryWrapper<SysDepart>();
        query.eq(SysDepart::getIzDelete, CommonConstant.IZ_DELETE_0.toString());
        query.eq(SysDepart::getEnterpriseInfoId, enterpriseInfoId);
        query.orderByAsc(SysDepart::getDepartOrder);
    ...
    @Override
    public List<DepartIdModel> queryDepartIdTreeList(String enterpriseInfoId) {
        LambdaQueryWrapper<SysDepart> query = new LambdaQueryWrapper<SysDepart>();
        query.eq(SysDepart::getIzDelete, CommonConstant.IZ_DELETE_0.toString());
        query.orderByAsc(SysDepart::getDepartOrder);
        List<SysDepart> list = this.list(query);
    ...
    @Override
    public SysDepart getByEnterpriseId(String id) {
        return sysDepartMapper.selectOne(new QueryWrapper<SysDepart>().eq("enterprise_info_id", id).eq("parent_id", "0"));
    }
    ...
    @Override
    @Transactional
    public void saveDepartData(@Validated SysDepart sysDepart, String username) {
...
//            String[] codeArray = (String[]) FillRuleUtil.executeRule(FillRuleConstant.DEPART, formData);
            ...
            sysDepart.setOrgCode(String.valueOf(DateUtils.getMillis()));
//            String orgType = codeArray[1];
//            sysDepart.setOrgType(sysDepart);
            sysDepart.setCreateTime(new Date());
            sysDepart.setIzDelete(CommonConstant.IZ_DELETE_0.toString());
            this.save(sysDepart);
        }
    ...
    @Override
    public void deleteBatchWithChildren(Collection<? extends Serializable> idList, String enterpriseInfoId) {
        this.baseMapper.delete(new QueryWrapper<SysDepart>().eq("enterprise_info_id", enterpriseInfoId)
                .in("id", idList)
        );
    }
