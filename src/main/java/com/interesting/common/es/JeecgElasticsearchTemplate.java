package com.interesting.common.es;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.interesting.common.util.RestUtil;
...
public class JeecgElasticsearchTemplate {
    ...
    public JeecgElasticsearchTemplate(){

    }
//    @Value("${jeecg.elasticsearch.cluster-nodes}") @Value("${jeecg.elasticsearch.check-enabled}")
    public JeecgElasticsearchTemplate(String baseUrl, boolean checkEnabled) {
