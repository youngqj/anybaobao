package com.interesting.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 com.interesting.business.system.model.DictModel cannot be cast to com.interesting.business.system.model.DictModel
