...
public class PmsUtil {
    ...
    public static String saveErrorTxtByList(List<String> msg, String name) {
        Date d = new Date();
        String saveDir = "logs" + File.separator + DateUtils.date2Str(d, DateUtils.yyyyMMdd) + File.separator;
        ...
        name +=  DateUtils.date2Str(d, DateUtils.yyyymmddhhmmss)  + Math.round(Math.random() * 10000);
